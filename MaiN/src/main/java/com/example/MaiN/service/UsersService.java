...
public class UsersService {
    ...
    public void addUser(String stdNo,String stdName){
        ...
        User foundUser = userRepository.findByStudentId(stdNo);

        if(foundUser == null){
            User user = new User();
            user.setStudentId(stdNo);
...
//        StringBuilder stdInfo = new StringBuilder();
    ...
    public TokenDto login(@NotNull LoginRequestDto loginRequestDto) {
        ...
        Optional<User> userOptional = Optional.ofNullable(userRepository.findByStudentId(stdNo));
...
//        refreshTokenRepository.save(refreshTokenDB);
    ...
    public TokenDto reissue(@NotNull TokenRequestDto tokenRequestDto) throws Exception {
        ...
        User user = userRepository.findByStudentId(stdNo);
        if(user == null){
    ...
    public boolean logout(String stdNo){
        ...
        if(userOptional.isPresent()) {
            ...
            Optional<User> updatedUser = Optional.ofNullable(userRepository.findByStudentId(stdNo));
