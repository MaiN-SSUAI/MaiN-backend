...
public class CalendarController {
    ...
    public String addEvent(@RequestBody EventDto eventDto) throws IOException, GeneralSecurityException, Exception {
        String eventId = calendarService.addEvent(eventDto.getLocation(), eventDto.getStudentNo(), eventDto.getStartDateTimeStr(), eventDto.getEndDateTimeStr());
    ...
    public String patch(@PathVariable("eventId") String eventId, @RequestBody EventDto eventDto) throws Exception{
        ...
        return calendarService.updateCalendarEvents(eventDto.getLocation(), eventDto.getStudentNo(), eventDto.getStartDateTimeStr(), eventDto.getEndDateTimeStr(),eventId);
